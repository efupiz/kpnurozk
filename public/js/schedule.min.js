...
(function($) {
	...
	Schedule.prototype = {
		...
		fillEmployeeDicts: function() {
			this.$('.ait-schedlfind-remark').append('<img class="wait" src="./images/Magnify.svg" alt="Зачекайте, будь-лакска..." />');
			$.ajax({
				type: "GET",
				dataType: "json",
		...
		fillStudentDicts: function() {
			if (this.options.studyGroupId) {
				...
				if (this.options.isRenderStudyTypeFilter) {
					this.$('.ait-schedlfind-stypes-block').append('<img class="wait" src="./images/Magnify.svg" alt="Зачекайте, будь-лакска..." />');
					$.ajax({
						type: "GET",
						dataType: "json",
		...
		fillChairedEmployeeDict: function() {
			...
			if (!a.aFacultyID) {
				...
				this.$('.ait-schedlfind-empblock').append('<img class="wait" src="./images/Magnify.svg" alt="Зачекайте, будь-лакска..." />');
				$.ajax({
					type: "GET",
					dataType: "json",
		...
		fillStudyGroupsDict: function() {
			...
			if (!a.aFacultyID && !a.aEducationForm && !a.aCourse) {
				...
				this.$('.ait-schedlfind-sg-block').append('<img class="wait" src="./images/Magnify.svg" alt="Зачекайте, будь-лакска..." />');
				$.ajax({
					type: "GET",
					dataType: "json",
		...
		requestSchedule: function(b) {
			...
			c.append('<img class="wait" src="./images/Magnify.svg" alt="Зачекайте, будь-лакска..." />');
			$.ajax({
				type: "GET",
				dataType: "json",
